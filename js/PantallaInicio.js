...
export const pilotosF1 = [
    new Piloto(1, "Lewis", "Hamilton",0, "Reino Unido", 0, "Titular"),
    new Piloto(2, "Max", "Verstappen",0, "Países Bajos", 0, "Suplente"),
    new Piloto(3, "Valtteri", "Bottas",0, "Finlandia", 0, "Titular"),
    new Piloto(4, "Sergio", "Pérez",0, "México", 0, "Suplente"),
    new Piloto(5, "Lando", "Norris",0, "Reino Unido", 0, "libre"),
    new Piloto(6, "Nico", "Hulkenberg",0, "Alemania", 0, "libre"),
    new Piloto(7, "Carlos", "Sainz",0, "España", 0, "Suplente"),
    new Piloto(8, "Charles", "Leclerc",0, "Mónaco", 0, "libre"),
    new Piloto(9, "Fernando", "Alonso",0, "España", 0, "Titular"),
